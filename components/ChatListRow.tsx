...
function ChatListRow({ chatId }: { chatId: string }) {
  ...
  const row = (message?: Message) => (
    <div
      ...
      className="flex p-5 mt-5 items-center space-x-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-700"
    >
      <UserAvatar
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-400 line-camp-1">
  ...
  return (
    <div>
      {loading && (
        <div className="flex p-5 mt-5 items-center space-x-2">
